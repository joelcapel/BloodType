...
public class JavaMailApi extends AsyncTask<Void, Void, Void> {
    ...
    public JavaMailApi(Context context, String email, String asunto, String mensaje) {
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Porfavor espere a que el email se envie");
        progressDialog.setTitle("Enviando email al donante");
        progressDialog.show();
        super.onPreExecute();
    }
