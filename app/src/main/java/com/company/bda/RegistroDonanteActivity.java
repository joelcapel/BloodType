...
public class RegistroDonanteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_donante);

        backButton = findViewById(R.id.backButton);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegistroDonanteActivity.this, LoginActivity.class);
        ...
        botonRegistro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodGroup.equals("Selecciona tu grupo de sangre")){
                    Toast.makeText(RegistroDonanteActivity.this, "Selecciona el grupo de sangre", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                Toast.makeText(RegistroDonanteActivity.this, "Error" + error, Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userInfo.put("type", "donante");
                                userInfo.put("buscar", "donante"+bloodGroup);

                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(RegistroDonanteActivity.this, "Datos introducidos correctamente", Toast.LENGTH_SHORT).show();
                                        }else{
                                            Toast.makeText(RegistroDonanteActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                if (resultUri !=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RegistroDonanteActivity.this, "Imagen subida", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()) {
                                                                    Toast.makeText(RegistroDonanteActivity.this, "URL de la imagen añadida a la BBDD correctamente", Toast.LENGTH_SHORT).show();
                                                                }else{
                                                                    Toast.makeText(RegistroDonanteActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                    ...
                                    Intent intent = new Intent(RegistroDonanteActivity.this, MainActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
                                }
